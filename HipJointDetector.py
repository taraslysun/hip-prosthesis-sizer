...
from HeadSegmentator import HeadSegmentator
from Detector import Detector



class HipJointDetector:
    def __init__(self, segm_model_path, head_segm_model_id, det_model_id):
        self.segm = Segmentator(model_path=segm_model_path)
        self.head_segm = HeadSegmentator(model_id=head_segm_model_id)
        self.det = Detector(model_id=det_model_id)
